...
var HTML5Player=function(){function a(a,c,d){this.el=a,b(this.el,navigator.userAgent),d&&d(this)}function b(a,b){/ipad/i.test(b)&&(a.controls=!0,a.addEventListener("play",function(){a.controls=!1},!1)),/android/i.test(b)&&(a.loop=!1,a.addEventListener("ended",function(){a.play()},!1))}return a.name=a.name||"HTML5Player",a.canPlay=function(a){try{for(var b=a.getElementsByTagName("source"),c=0,d=b.length;d>c;c++){var e=b[c].getAttribute("type"),f=a.canPlayType(e);if(f)return!0}}catch(g){}return!1},a.fn=a.prototype,a.fn.play=function(){this.el.play()},a.fn.pause=function(){this.el.pause()},a.fn.paused=function(){return this.el.paused},a.fn.mute=function(){this.el.muted=!0},a.fn.unmute=function(){this.el.muted=!1},a.fn.muted=function(){return this.el.muted},a}(),FlashPlayer=function(a){function b(b,e,f){e.size||(e.size=l);var g=this,h="divinePlayer_onReady_"+(new Date).getTime();f&&(a[h]=function(){f(g)});var m=k(b.getAttribute("data-fallback-player"),e.swf);if(!m)throw"SWF url must be specified.";this.swf=i(m,b,{size:e.size,autoplay:j(b,"autoplay"),muted:j(b,"muted"),loop:j(b,"loop"),poster:j(b,"poster")?c(b.getAttribute("poster")):void 0,video:d(b),onReady:h})}function c(a){return 0===(a||"").indexOf("//")?document.location.protocol+a:a}function d(a){var b=a.getElementsByTagName("source");return b.length?c(b[0].src):void 0}function e(a){return h(a,function(a,b){return a+'="'+b+'"'}," ")}function f(a){return h(a,function(a,b){return"<param "+e({name:a,value:b})+" />"},"\n")}function g(a){return h(a,function(a,b){return a+"="+encodeURIComponent(b)},"&")}function h(a,b,c){var d=[];for(var e in a)a.hasOwnProperty(e)&&d.push(b(e,a[e]));return d.join(c)}function i(a,b,c){var d=e({id:b.id,data:a,width:c.size,height:c.size,type:"application/x-shockwave-flash"}),h=f({movie:a,allowScriptAccess:"always",allowNetworking:"all",wmode:"opaque",quality:"high",bgcolor:"#000000",flashvars:g(c)});return b.outerHTML="<object "+d+">"+h+"</object>",document.getElementById(b.id)}function j(a,b){return void 0!==a.getAttribute(b)}function k(a,b){return null==b?a:b}var l=150;return b.name=b.name||"FlashPlayer",b.canPlay=function(){try{if(/MSIE 10/i.test(navigator.userAgent))return!1;var a=window.ActiveXObject?new ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version"):navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin.description,b=/(\d+)[,.]\d+/.exec(a),c=parseInt(b[1],10);return c>=9}catch(d){}return!1},b.fn=b.prototype,b.fn.play=function(){this.swf.divinePlay()},b.fn.pause=function(){this.swf.divinePause()},b.fn.paused=function(){return this.swf.divinePaused()},b.fn.mute=function(){this.swf.divineMute()},b.fn.unmute=function(){this.swf.divineUnmute()},b.fn.muted=function(){return this.swf.divineMuted()},b}(this),DivinePlayer=function(){function a(d,f,g){b(d,"Element must be defined.");for(var f=f||{},h=0,i=e.length;i>h;h++){var j=e[h],k=f[e[h]];null!=k&&c(d,j,k)}var l=b(a.getSupportedPlayer(d),"No supported player found.");return new l(d,f,g)}function b(a,b){if(!a)throw b||"Requirement isn't fullfilled";return a}function c(a,b,c){if(c)try{a.setAttribute(b,b)}catch(d){}else a.removeAttribute(b)}var d=[HTML5Player,FlashPlayer],e=["autoplay","controls","loop","muted"];return a.players=d,a.options=e,a.getSupportedPlayer=function(a){for(var b=0,c=d.length;c>b;b++)if(d[b].canPlay(a))return d[b]},a}();
return DivinePlayer;}());